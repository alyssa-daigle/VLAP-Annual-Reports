...
Figure `r fig_counter`. Plot showing 2025 profiles temperature (degrees Celcius, green points, left) and dissolved oxygen (mg/L, blue points, right) by depth in meters. Month of profile is indicated by point shape and darkness of color (earlier season - lighter; later season - darker). 
...
Figure `r fig_counter`. Plot showing the relative abundance of phytoplankton communities over time. 
