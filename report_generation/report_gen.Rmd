...
### **Individual Report: LAKE NAME – TOWN**
...
station <- "SPOCHED"  # change per lake
...
#### Table 1. 2025 Average Water Quality Data for SPOFFORD LAKE, CHESTERFIELD
```{r}
lake <- "spofford"  # change per lake
...
ft_cya <- flextable(cya_data) |>
  ...
  border_inner_h(part = "all", border = fp_border(color = "black", width = 1)) |>
  border_inner_v(part = "all", border = fp_border(color = "black", width = 1)) |>
  # 1. Header row centered
  align(align = "center", part = "header") |>
  # 2. First column left-aligned, except first cell
  align(j = 1, i = 2:nrow(cya_data), align = "left", part = "body") |>
  # 3. Remaining body cells centered
